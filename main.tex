...
PWAstats \cite{PWAstats} on julkaissut tilastoja miten yritysten nykyisten sivujen muuttaminen PWA malliin on tuottanut lisätuloja tai käyttäjiä. Tämän työn tarkoituksena on selvittää mitä hyötyjä PWA malli tuo mukanaan.
