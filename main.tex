...
Verkkoselaimen rajapinnat ovat jo melkoisen kattavat. Selaimesta päästään helposti käsiksi mobiililaitteen toimintoihin kuten esimerkiksi kameraan ja GPS anturiin. PWA sovellukset pyrkivät hyödyntämään näitä selaimen tukemia rajapintoja. Mikäli sovelluksessa on tarkoitus käyttää jotain osa-aluetta mitä selain ei tue, silloin on luonnollista tehdä natiivisovellus. Esimerkiksi jos on tarkoitus päästä käsiksi käyttäjän yhteystietoihin sitä ei voida järkevästi toteuttaa PWA teknologialla, ainakaan vielä.
