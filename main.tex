...
\begin{figure}[!ht]
\begin{center}
\epsfig{figure=install_banner.jpg,  width=0.5\textwidth}
\caption{Telia IoT PWA sovelluksen asennusbanneri. Laitteen taustaväri on sama kuin sovelluksen väriteema, sekä sovellusluetteloon tuleva kuvake on määritelty manifestissa.}
